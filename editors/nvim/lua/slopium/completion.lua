...
local static_items = {
  ...
  { label = "print", kind = kinds.Function, detail = "print a scalar or String" },
  { label = "println", kind = kinds.Function, detail = "print with newline" },
  { label = "read-i64", kind = kinds.Function, detail = "read i64 from stdin" },
  { label = "read-line", kind = kinds.Function, detail = "read-line() -> String" },
  { label = "parse-i64", kind = kinds.Function, detail = "parse-i64(&String) -> i64" },
  { label = "env", kind = kinds.Function, detail = "env(&String) -> String" },
  { label = "args-len", kind = kinds.Function, detail = "count process arguments" },
  { label = "arg", kind = kinds.Function, detail = "arg(i64) -> String" },
